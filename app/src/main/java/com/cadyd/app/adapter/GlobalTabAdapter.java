 ...
 * Author: wcy
 */
public class GlobalTabAdapter implements RadioGroup.OnCheckedChangeListener {
    ...
    public GlobalTabAdapter(FragmentActivity fragmentActivity, final List<Fragment> fragments, int fragmentContentId, final RadioGroup rgs) {
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
        ...
        if (checkedId == R.id.global_doing) {
