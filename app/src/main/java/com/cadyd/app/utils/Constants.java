...
public class Constants {
	...
	public static final String ENDPOINT = "http://oss-cn-hangzhou.aliyuncs.com";//阿里ossendpoint
	public static final String BUCKETNAME = "schimages";//阿里ossbucketname
	public static final String CALLBACKADDRESS = "http://bean.tunnel.phpor.me/sch_merchant_manager/fileupdown/goods/appOssCallbackApp";//阿里回调地址
}
