...
public class BitmapUtil {
     ...
     * @return
     */
    public static Bitmap ResourcesBimap(Resources res, int resid) {
    ...
    public static Bitmap createReflectionImageWithOrigin(Bitmap bitmap) {
        ...
        LinearGradient shader = new LinearGradient(0, bitmap.getHeight(), 0, bitmapWithReflection.getHeight() + reflectionGap,
    ...
    public static byte[] bitmapToString(String filePath) {
        Bitmap bm = getImageThumbnail(filePath, 800, 800);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        bm.compress(Bitmap.CompressFormat.JPEG, 60, baos);//100
