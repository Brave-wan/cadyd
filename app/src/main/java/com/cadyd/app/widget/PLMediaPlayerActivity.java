...
/**
 */
public class PLMediaPlayerActivity extends BaseFragmentActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rootView = (RelativeLayout) findViewById(R.id.usercenter_title);
