package com.cadyd.app.ui.view.expandablebutton;
...
public class AllAngleExpandableButton extends View implements ValueAnimator.AnimatorUpdateListener {
    ...
    private static MerchantCodePopupWindow codePopupWindow;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        codePopupWindow = new MerchantCodePopupWindow(context);
    ...
    private static class MaskView extends View {
        ...
        private void onButtonPressed() {
            ...
            if (clickIndex == 3){
                codePopupWindow.showPop(allAngleExpandableButton);
            } else {
                allAngleExpandableButton.collapse();
            }
        }
