...
public class DragLayout extends ViewGroup {
	 ...
	 * 如果用户抬起第一个手指（pointerId= 0），并且第二指（pointerId= 1）执行onInterceptTouchEvent ，
	 * 该DrawerLayout不会存储该指针信息（pointerId=1）当DrawerLayout得到ACTION_MOVE事件，
	 * 它希望得到的pointerId指针信息。 然而，DrawerLayout只有指针​​=0，mInitialMotionX的数组大小仍为1。
	 */
