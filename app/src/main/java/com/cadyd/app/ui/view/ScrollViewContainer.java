...
public class ScrollViewContainer extends RelativeLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!isMeasured) {
            isMeasured = true;
            mViewHeight = getMeasuredHeight() - 100;
    ...
    private OnTouchListener topViewTouchListener = new OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (onScrollChange != null) {
                onScrollChange.overScrollBy((int) sv.getScrollY());
            }
    ...
    private ScrollChange onScrollChange;

    public void setOnScrollChange(ScrollChange onScrollChange) {
        this.onScrollChange = onScrollChange;
    }

    public interface ScrollChange {
        public void overScrollBy(int scrollY);
    }
}
