...
public class UserFansFragment extends BaseFragement {
    ...
    public void getAttentListData() {
        ...
        map.put("pageSize", "10");
        RequestBody body = ApiClient.getRequestBody(map);
        HttpMethods.getInstance().getFansList(new ProgressSubscriber<BaseRequestInfo<AttentionUserInfoListDataModel>>(mOnNextListener, getActivity()), body);
    }
}
