...
public class ScrollerNumberPicker extends View {
     ...
     * 选中的时候字体
     */
    private float selectedFont = 12.0f;
    /**
     * 单元格高度
     */
    ...
    private void drawLine(Canvas canvas) {
        ...
        canvas.drawLine(0, controlHeight / 2 - unitHeight / 2 + 2, controlWidth, controlHeight / 2 - unitHeight / 2 + 2,
                linePaint);
        canvas.drawLine(0, controlHeight / 2 + unitHeight / 2 - 2, controlWidth, controlHeight / 2 + unitHeight / 2 - 2,
                linePaint);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        normalFont = attribute.getDimension(R.styleable.NumberPicker_normalTextSize, 10.0f);
        selectedFont = attribute.getDimension(R.styleable.NumberPicker_selecredTextSize, 12.0f);
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 绘制内容
            canvas.drawText(itemText, x + controlWidth / 2 - textRect.width() / 2, y + move + unitHeight / 2 + textRect.height()
                    / 2, textPaint);
