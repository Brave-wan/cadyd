...
public class TitlePopup extends PopupWindow {
    ...
    public TitlePopup(Context context, int width, int height) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.title_popup, null);
        LinearLayout popup_bg = (LinearLayout) view.findViewById(R.id.popup_bg);
        popup_bg.getBackground().setAlpha(160);
        //设置弹窗的布局界面
        setContentView(view);
    ...
    public void show(View view) {
        ...
        int f = (mScreenWidth - LIST_PADDING - (getWidth() / 2));
        //显示弹窗的位置
        showAtLocation(view, popupGravity, f, mRect.bottom);
    }
