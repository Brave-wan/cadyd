 ...
 * @author wcy
 */
public class RankGoodsFragment extends BaseFragement {
    ...
    public static RankGoodsFragment newInstance(String gid) {
        RankGoodsFragment newFragment = new RankGoodsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return setView(R.layout.fragment_rank_goods, "排行榜", true);
    }
    ...
    protected void initView() {
        ...
        adapter = new CommonAdapter<Good>(activity, mlist, R.layout.goodes_rank_list_iteam) {
            ...
            public void convert(ViewHolder helper, final Good item) {
                ...
                helper.setText(R.id.bought, String.format("以有%d人购买", item.bought));
